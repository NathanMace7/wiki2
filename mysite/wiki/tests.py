...
class PageCreationTestCase(TestCase):
    def setUp(self):
        page = Page.objects.create(title ="Hello World A", content = "hello world a")
        page.save()

        page = Page.objects.create(title = "Hello World B", content = "hello world b")
        page.save()

    def test_hello_world_a(self):
        response = self.client.get('/wiki/Hello World A/')
        self.assertContains(response, 'hello world a')

    def test_hello_world_b(self):
        response = self.client.get('/wiki/Hello World B/')
        self.assertContains(response, 'hello world b')
    ...
    def test_edit_page(self):
        response = self.client.get('/wiki/editing/edit/')
